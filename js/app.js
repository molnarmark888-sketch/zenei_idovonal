...
audioLoader.load('zene/cello.wav', (b) => { warpSound.setBuffer(b); warpSound.setVolume(1.0); });
audioLoader.load('zene/westcoast.mp3', (b) => { music.setBuffer(b); music.setLoop(true); music.setVolume(0.5); });
...
new FBXLoader().load('3d/spaceship4.fbx', (obj) => {
